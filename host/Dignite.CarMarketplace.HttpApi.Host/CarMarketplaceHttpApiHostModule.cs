...
public class CarMarketplaceHttpApiHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<CarMarketplaceDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}Dignite.CarMarketplace.Domain", Path.DirectorySeparatorChar)));
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<CarMarketplaceApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}Dignite.CarMarketplace.Application", Path.DirectorySeparatorChar)));
            });
        }
        ...
        context.Services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                {"CarMarketplace", "CarMarketplace API"}
            },
            options =>
            {
        ...
        context.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
            .AddJwtBearer(options =>
            {
                ...
                options.Audience = "CarMarketplace";
            });
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseAbpSwaggerUI(options =>
        {
            ...
            options.OAuthScopes("CarMarketplace");
        });
        app.UseAuditing();
