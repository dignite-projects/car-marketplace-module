...
public class ClientDemoService : ITransientDependency
{
    ...
    private async Task TestWithDynamicProxiesAsync()
    {
        ...
        //var result = await _dealerAppService.GetAsync();
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:CarMarketplace:BaseUrl"] +
                      "api/car-marketplace-dealer-platform/dealer/find-by-current-user";
