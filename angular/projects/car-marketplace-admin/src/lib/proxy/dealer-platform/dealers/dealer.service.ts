...
export class DealerService {
  ...
  addAdministrator = (userId: string, config?: Partial<Rest.Config>) =>
  ...
  shortNameExists = (shortName: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, boolean>({
      method: 'PUT',
      url: '/api/car-marketplace-dealer-platform/dealer/short-name-exists',
      params: { shortName },
    },
    { apiName: this.apiName,...config });
