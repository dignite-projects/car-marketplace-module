...
{
    public class DealerPlatformAppService : CarMarketplaceAppService, IDealerPlatformAppService
    {
        private readonly IDealerRepository _dealerRepository;
        private readonly ICmsUserRepository _cmsUserRepository;
        private readonly DealerManager _dealerManager;

        public DealerPlatformAppService(IDealerRepository dealerRepository, ICmsUserRepository cmsUserRepository, DealerManager dealerManager)
        {
