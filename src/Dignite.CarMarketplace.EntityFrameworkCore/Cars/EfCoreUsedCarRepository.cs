...
public class EfCoreUsedCarRepository : EfCoreRepository<ICarMarketplaceDbContext, UsedCar, Guid>, IUsedCarRepository
{
    ...
    public async Task<int> GetCountAsync(CarStatus? status = null, string filter = null, Guid? brandId = null, Guid? modelId = null, Guid? dealerId = null, string color = null, DateTime? minRegistrationDate = null, DateTime? maxRegistrationDate = null, float? minTotalMileage = null, float? maxTotalMileage = null, float? minPrice = null, float? maxPrice = null, string transmissionType = null, string powerType = null, string modelLevel = null, CancellationToken cancellationToken = default)
    {
        ...
        minPrice, maxPrice, transmissionType, powerType, modelLevel))
        .CountAsync(GetCancellationToken(cancellationToken));
    }

    public async Task<List<UsedCar>> GetListAsync(CarStatus? status = null, string filter = null, Guid? brandId = null, Guid? modelId = null, Guid? dealerId = null, string color = null, DateTime? minRegistrationDate = null, DateTime? maxRegistrationDate = null, float? minTotalMileage = null, float? maxTotalMileage = null, float? minPrice = null, float? maxPrice = null, string transmissionType = null, string powerType = null, string modelLevel = null, int maxResultCount = int.MaxValue, int skipCount = 0, string sorting = null, CancellationToken cancellationToken = default)
    {
        return await(await GetQueryableAsync(status ,filter ,  brandId , modelId ,  dealerId , color ,
         minRegistrationDate ,  maxRegistrationDate ,  minTotalMileage ,  maxTotalMileage ,
          minPrice ,  maxPrice , transmissionType , powerType , modelLevel ))
    ...
    protected virtual async Task<IQueryable<UsedCar>> GetQueryableAsync(
         ...
         float? minPrice = null, float? maxPrice = null, string transmissionType = null, string powerType = null, string modelLevel = null)
    {
